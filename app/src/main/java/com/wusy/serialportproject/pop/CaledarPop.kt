...
class CaledarPop(context: Context,listener:OnUpdateListener) : BasePopupWindow(context) {
    var ivCancel = findViewById<ImageView>(R.id.ivCancel)
    var ivTurnUp=findViewById<ImageView>(R.id.ivTurnUp)
    var ivTurnDown=findViewById<ImageView>(R.id.ivTurnDown)
    ...
    override fun onCreateContentView(): View {
        return createPopupById(R.layout.pop_selectcaledar)
    }
